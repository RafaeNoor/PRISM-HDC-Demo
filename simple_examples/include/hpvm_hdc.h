...
/// Declaration of types for hypervectors and hypermatrices
template<int N, typename elemTy>
//using __hypervector__ __attribute__((__ext_vector_type__(N))) = elemTy;
...
/// Create uninitialized hypervectors and hypermatrices
template<int N, typename elemTy>
...
/// Create initialied hypervector and hypermatrix (these function could be added to a library)
template<int N, typename elemTy>
...
/// Operations between hypermatrices
template<int M, int N, typename elemTy>
...
/// Operations to access hyper matrices
template<int M, int N, typename elemTy>
